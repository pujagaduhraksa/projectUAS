            ...
            <div class="col-12">
                ...
                <form method="POST" action="/detail/{{$exams->id}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('kategori_id') is-invalid @enderror" id="kategori_id" placeholder="Masukkan Kategori" name="kategori_id" value="{{ $exams->kategori_id }}">
                        @error('kategori_id')
                            <div class="invalid-feedback"> {{ $message }}</div>
                        @enderror
                    </div>
